...
USERPROFILE_PREFIX_LINE = "# automatically generated by dotfiles ({})\n"
...
def install(dir: str):
    ...
    with open(yml_path, "r") as f:
        ...
        if "env_vars" in config:
            ...
            print("writing env variables to", pathName(env_var_file))
            with open(env_var_file, "a") as f:
                f.write("# automatically generated by dotfile config {}\n".format(dir))
        ...
        if USERPROFILE_FILE in os.listdir(dir):
            ...
            with open(os.path.join(dir, USERPROFILE_FILE), "r") as f_source:
                ...
                with open(os.path.join(HOME_DIR, USERPROFILE_FILE), "a") as f_dest:
                    f_dest.write(USERPROFILE_PREFIX_LINE.format(dir) + content + "\n")
    print()
